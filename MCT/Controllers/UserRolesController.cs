...
namespace MCT.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(MctContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("RoleName")] UserRole userRole)
        {
            if (id != userRole.RoleName)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!UserRoleExists(userRole.RoleName))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.UserRoles.Any(e => e.RoleName == id);
        }
    }
}
