...
public partial class MctContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserRole>(entity => { entity.HasKey(e => e.RoleName).HasName("user_roles_pkey"); entity.ToTable("user_roles"); entity.Property(e => e.RoleName).HasMaxLength(20).HasColumnName("role_name"); });
