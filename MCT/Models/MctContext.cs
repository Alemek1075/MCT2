...
public partial class MctContext : DbContext
{
    ...
    public MctContext(DbContextOptions<MctContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Match>(entity =>
        {
            ...
            entity.HasOne(d => d.MatchTypeNavigation).WithMany(p => p.Matches)
                .HasForeignKey(d => d.MatchType)
        ...
        {
            entity.HasKey(e => e.TypeName).HasName("match_types_pkey");
            entity.ToTable("match_types");
            entity.Property(e => e.TypeName).HasMaxLength(10).HasColumnName("type_name");
        });
        ...
        {
            entity.HasKey(e => e.StatusName).HasName("payment_statuses_pkey");
            entity.ToTable("payment_statuses");
            entity.Property(e => e.StatusName).HasMaxLength(20).HasColumnName("status_name");
        });
        ...
        modelBuilder.Entity<Stat>(entity =>
        {
            ...
            entity.Property(e => e.HsPercentage).HasPrecision(5, 2).HasColumnName("hs_percentage");
            entity.Property(e => e.Kills).HasColumnName("kills");
            entity.Property(e => e.MatchId).HasColumnName("match_id");
            entity.Property(e => e.PlayerId).HasColumnName("player_id");

            entity.HasOne(d => d.Match).WithMany(p => p.Stats)
                .HasForeignKey(d => d.MatchId)
                .HasConstraintName("stats_match_id_fkey");
            entity.HasOne(d => d.Player).WithMany(p => p.Stats)
        ...
        modelBuilder.Entity<Team>(entity =>
        {
            ...
            entity.Property(e => e.ShortCode).HasMaxLength(3).IsFixedLength().HasColumnName("short_code");
        });
        ...
        modelBuilder.Entity<Ticket>(entity =>
        {
            ...
            entity.Property(e => e.QrCode).HasMaxLength(255).HasColumnName("qr_code");
            entity.Property(e => e.Status).HasMaxLength(20).HasColumnName("status");
            entity.Property(e => e.TournamentId).HasColumnName("tournament_id");
            entity.Property(e => e.UserId).HasColumnName("user_id");
            ...
            entity.HasOne(d => d.Tournament).WithMany(p => p.Tickets)
                .HasForeignKey(d => d.TournamentId)
        ...
        {
            entity.HasKey(e => e.StatusName).HasName("ticket_statuses_pkey");
        ...
        modelBuilder.Entity<Tournament>(entity =>
        {
            ...
            entity.HasOne(d => d.StatusNavigation).WithMany(p => p.Tournaments)
                .HasForeignKey(d => d.Status)
        ...
        {
            entity.HasKey(e => e.StatusName).HasName("tournament_statuses_pkey");
        ...
        {
            entity.HasKey(e => e.Id).HasName("tournament_teams_pkey");
